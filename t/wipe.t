...

{
    ...
    OK have => +$stub.output.join.lines > 50,
       desc => "At least 50 output lines were generated by second wipefirst attempt";
    $stub.output = ();
    ...
    OK have => +$stub.output.join.lines < 2,
       desc => "Less than two output lines were generated by second wipefirst attempt";
}
...
# 
#     OK have => +$stub.output.lines > 50,
#        desc => "At least 50 output lines were generated by wipe attempt";
#     $stub.output = ();
# }
